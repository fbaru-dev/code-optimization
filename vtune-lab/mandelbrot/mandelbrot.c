...
void compute_mandelbrot() __attribute__((noinline));
...
void compute_mandelbrot()
{
    #pragma omp parallel
    {
        ...
        // Change to #pragma omp for schedule(dynamic) for better load balance
#pragma omp for
...
int main(int argc, char *argv[]) {
    ...
    /* Uncomment if you want the picture to stay */
